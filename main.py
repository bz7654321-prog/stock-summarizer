...
4. "급등", "상한가", "세력" 등 자극적인 단어는 객관적인 톤으로 순화해서 적어라.
5. 영상 정보(채널명, 링크 등)는 출력하지 마라.
6. 단순 언급된 종목은 구구절절 설명하지 말고 한 줄에 묶어서 간단히 나열해라.
...
- 가격 전략: 매수가 [가격] / 목표가 [가격] / 손절가 [가격] (※ 가격 언급이 있을 때만 작성, 없으면 이 줄 삭제)
